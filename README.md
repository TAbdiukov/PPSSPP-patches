...
* [Analysing PPSSPP RAM with IDA Pro](./guides/IDA-PPSSPP.md) *(with a bonus part on accelerating your analysis with ChatGPT)*
...
* [Miscellaneous cheats](./guides/Misc.md) *(including undocumented inbuilt cheats)*

#### Datasets
*Useful data*

* [GTA: CW - Vehicle IDs](./guides/Datasets/HP-GoF-Levels.md)
* [Harry Potter: Goblet of Fire - Valid Level IDs](./guides/Datasets/HP-GoF-Levels.md)
